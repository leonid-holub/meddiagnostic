    ...
    return (
        <section className="section advantages" id="advantages">
            <div className="container">
                <h2 className={`${style.advantages__title} ${h2OnScreen ? "animate__fadeInDown animate__animated" : ''}` }>Переваги</h2>
                <div className={style.advantages__description}>
                    <ul className={`${style.list} ${ulOnScreen ? "animate__fadeInLeft animate__animated" : ''}`}>
                        <li className={style.item}>
                            <svg className={style.item__icon} width="100" height="100">
                                <use href="/public/images/icons.svg#icon-quality-control"></use>
                            </svg>
                        ...
                        <li className={style.item}>
                            <svg className={style.item__icon} width="100" height="100">
                                <use href="/public/images/icons.svg#icon-bankrupt"></use>
                            </svg>
                            <div className={style.item__text}>
                        ...
                        <li className={style.item}>
                            <svg className={style.item__icon} width="100" height="100">
                                <use href="/public/images/icons.svg#icon-certificate"></use>
                            </svg>
                            <div className={style.item__text}>
                        ...
                        <li className={style.item}>
                            <svg className={style.item__icon} width="100" height="100">
                                <use href="/public/images/icons.svg#icon-fast-delivery"></use>
                            </svg>
                            <div className={style.item__text}>
                    ...
                    <img className={`${style.image} ${imgOnScreen ? "animate__fadeInRight animate__animated" : ''}`} src="/public/images/home/advantages.jpg" width="500px"/>
                </div>
            </div>
        </section>
    )
