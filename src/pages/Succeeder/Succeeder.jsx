            ...
            <section className={style.products}>
                    ...
                    <div className="container">
                        <div className={style.product__odd__wrapper}>
                            <div className={style.product__description}>
                                <h3 className={style.product__title}>Повністю автоматизований аналізатор коагуляції SF-8200</h3>
                                <p className={style.product__paragraph}>Повністю автоматизований аналізатор коагуляції SF-8200 використовує згортання та імунотурбідиметрію, хромогенний метод для перевірки згортання плазми. Прилад показує, що значенням вимірювання згортання є час згортання (у секундах)</p>
                    ...
                    <div className="container">
                        <div className={style.product__odd__wrapper}>
                            <div className={style.product__description}>
                                ...
                                <p className={style.product__paragraph}>SF-8050 можна використовувати для клінічного тестування та передопераційного скринінгу. SF-8050 використовує коагуляцію та імунотурбідиметрію, хромогенний метод для перевірки згортання плазми. Прилад показує, що значенням вимірювання згортання є час згортання (у секундах). Якщо тестовий елемент відкалібровано за допомогою калібрувальної плазми, він також може відображати інші відповідні результати</p>
                                <ul className={style.product__list}>
                                    <li className={style.product__item}>
                                    Розроблено для лабораторії середнього та великого рівня 
                                    </li>
                                ...
                                <p className={style.product__paragraph}>Продукт складається з рухомого блоку зонда для відбору проб, блоку очищення, блоку рухомої кювети, блоку нагріву та охолодження, блоку тестування, блоку відображення операцій, інтерфейсу RS232 (використовується для принтера та передачі дати на комп’ютер)</p>
                            </div>
                            <div className={style.product__appearance}>
                ...
                <div className={style.product_even}>
                    <div className="container">
                        <div className={style.product__even__wrapper}>
                            <div className={style.product__description}>
                                <h3 className={style.product__title}>Напівавтоматичний аналізатор коагуляції SF-400</h3>
                                <p className={style.product__paragraph}>SF-400 виконує функції попереднього нагрівання реагенту, магнітного перемішування, автоматичного друку, накопичення температури, індикації часу тощо. Еталонна крива зберігається в приладі, а діаграму кривої можна роздрукувати. Принцип тестування цього приладу полягає у виявленні амплітуди коливань сталевих кульок у тестових отворах за допомогою магнітних датчиків і отриманні результатів тестування шляхом обчислення. За допомогою цього методу в’язкість вихідної плазми, гемоліз, хілемія чи жовтяниця не заважатимуть тесту. Штучні похибки зменшуються завдяки використанню електронного пристрою для нанесення зразків, що гарантує високу точність і повторюваність. Цей продукт підходить для визначення фактора згортання крові в медичних, науково-дослідних та освітніх установах</p>
                                <ul className={style.product__list}>
                                    <li className={style.product__item}>
                                    Система (механічного) визначення в'язкості 
                                    </li>
                                    <li className={style.product__item}>
                                    Відсутність втручання інтернів, гемолізу, та каламутних частинок
                                    </li>
                                    <li className={style.product__item}>
                                    4 незалежні тестові канали з випадковими та паралельними тестами
                                    </li>
                                    <li className={style.product__item}>
                                    Оригінальні реагенти, Контрольна плазма, Калібратор плазми
                                    </li>
                                    <li className={style.product__item}>
                ...
                <div className={style.product_odd}>
                    <div className="container">
                        <div className={style.product__odd__wrapper}>
                            <div className={style.product__description}>
                                <h3 className={style.product__title}>ШОЕ Аналізатор SD-1000</h3>
                                ...
                                <ul className={style.product__list}>
                                    ...
                                    <li className={style.product__item}>
                                    Для трубки потрібно: зовнішній діаметр φ(8±0,1) мм, висота трубки не менше 110 мм
                                    </li>
                                    <li className={style.product__item}>
                                    Вага: 16 кг
                                    </li>
